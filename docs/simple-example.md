...
```
T_INT T_MAINT_LPARENT_RPAREN T_LBRACE
    T_INT T_IDT_SEMI
    T_DOUBLE T_ID T_ASSIGN T_FCONSTT_SEMI
    T_FOR T_LPARENT_ID T_ASSIGN T_ICONSTT_SEMI T_ID T_RELOP T_ICONSTT_SEMI T_IDT_INCDECT_RPAREN T_LBRACE
        T_ID T_ASSIGN T_ID T_ADDOP T_ID T_ADDOP T_IDT_SEMI
    T_RBRACE
    T_PRINT T_IDT_SEMI
    T_RETURN T_ICONSTT_SEMI
T_RBRACE
```
